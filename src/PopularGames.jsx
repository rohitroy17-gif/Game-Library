...
const PopularGames = () => {
  ...
  return (
    <div className="grid md:grid-cols-3 p-4 gap-4 mt-8 bg-gray-800">
      {sortedGames.map(game => (
        <div 
          key={game.id} 
          className="border p-4 rounded-2xl cursor-pointer bg-gray-600 hover:shadow-lg transform hover:scale-105 transition"
